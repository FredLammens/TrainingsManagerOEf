...
namespace Tests
{
    //maak fluent assertions pls danku
    [TestClass]
    public class TrainingManagerTests
    {
        ...
        [TestMethod]
        public void AddRunningTrainingWithInvalidDistance()
        {
            //Arrange
            DateTime now = DateTime.Now;
            float distanceToBig = 510;
        ...
        [TestMethod]
        public void AddRunningTrainingWithInvalidTime()
        {
            //Arrange
            DateTime now = DateTime.Now;
            float distance = 400;
        ...
        [TestMethod]
        public void AddRunningTrainingWithInvalidAverageSpeed()
        {
            //Arrange
            DateTime now = DateTime.Now;
            float distance = 400;
        ...
        [TestMethod]
        public void AddRunningTrainingWithInvalidWatt()
        {
            //Arrange
            DateTime now = DateTime.Now;
            float distance = 400;
